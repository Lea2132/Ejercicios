...
int i=0;
int cont=0;
//ciclo while para ver segun la edad cuantas veces cabe el 4 entero sin decimales 
while(i==0){
    if(auxi>=4){
        auxi-=4;
        cont+=1;
...
Console.WriteLine("los dias antes de años biciestos"+dias);
dias=(edad*365+cont);
double semanas=(edad*52);
